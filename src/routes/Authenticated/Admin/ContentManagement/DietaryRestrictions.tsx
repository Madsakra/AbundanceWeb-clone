...
export const headers = [
    "Dietary Restriction ID","Name","Variation"
  ]
...
export default function DietaryRestrictions() {
  ...
  const fetchData = async (action: "start" | "next" | "prev") => {
    ...
    try {
      ...
      let q;
      const accountsRef = collection(db, "dietary_restrictions");
  ...
  const dropDowns = [
    { 
      actionName:"Edit Dietary Restrictions",
      action:editData
    },
    {
      actionName:"Delete Dietary Restrictions",
      action:deleteData
    }
  ]
    ...
    <>
      ...
      :
          ...
          
        {
            openForm &&
            <SpecialisationForm
            collectionName="dietary_restrictions"
            openForm={openForm}
            setOpenForm={setOpenForm}
            selectedSpecialisation={selectedData}
            fetchData={fetchData}
            naming="Dietary Restrictions"
            />
        }

         {
          ...
          <div className="w-[80vw] h-auto border-2 p-8 rounded-xl">
            ...
            <div className="flex flex-row justify-between">
              {/*Header section*/}
              <TableHeaderBar
              mainText="Dietary Restrictions"
              subText="Manage your Dietary Restrictions across applications"
              />
            ...
            <Table className="my-10">
              ...
              <TableRow>
                <TableCell colSpan={headers.length} className="pt-8">Showing 1 - {baseData?.length} Dietary Restrictions</TableCell>
